...
// time id sw /install/uninstall
public class DebianSWMonitor extends LinuxMonitor {
	...
	public static String cmd="dpkg-query";
	public static String par=" -l";
	...
	{
		DebianSWMonitor m=new DebianSWMonitor();
		while(true){
	...
	public LinkedList<MySoftware> getProcess()
	{
		...
		OutterCmd oc = new OutterCmd(cmd+" "+par);//rpm -qa
		String str;
